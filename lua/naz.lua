...
Group.new("DashboardCenter", c.light_yellow, c.none, no)
Group.new("DashboardCenterIcon", c.cyan, c.none, no)
Group.new("DashboardShortCut", c.pink, c.none, no)
Group.new("DashboardFooter", c.vivid_orange, c.none, no)
...
Group.link("TelescopeSelection", g.Visual)
Group.link("TelescopeSelectionCaret", g.Visual)
Group.new("TelescopeMultiSelection")
Group.new("TelescopeMultiIcon")

-- "Normal" in the floating windows created by telescope.
Group.link("TelescopeNormal", g.Normal)
...
Group.new("TelescopePreviewDirectory", c.light_blue, c.none)
...
Group.new("TelescopePreviewUser", c.light_green, c.none, i)
Group.new("TelescopePreviewGroup", c.light_green, c.none, i)
