...
--Group.new('Folded',           { 'fg': s:warmgrey,    'bg': s:darkgrey })
-- 'foldcolumn'
--Group.new('FoldColumn',       { 'bg': s:darkgrey })
-- column where signs are displayed
--Group.new('SignColumn',       { 'bg': s:lightblack })
-- 'incsearch' highlighting; also used for the text replaced with ":s///c"
--Group.new('IncSearch',        { })
-- Line number for ":number" and ":#" commands, and when 'number' or 'relativenumber' option is set.
--Group.new('LineNr',           { 'fg': s:springgreen, 'bg': s:black })
-- Like LineNr when 'cursorline' or 'relativenumber' is set for the cursor line.
--Group.new('CursorLineNr',     { 'fg': s:orange,      'bg': s:lightblack })
-- The character under the cursor or just before it, if it is a paired bracket, and its match.
--Group.new('MatchParen',       { 'fg': s:black,       'bg': s:lightgrey })
-- 'showmode' message (e.g., "-- INSERT --")
--Group.new('ModeMsg',          { 'fg': s:yellow })
-- more-prompt
--Group.new('MoreMsg',          { 'fg': s:yellow })
...
--Group.new('NonText',          { 'fg': s:lightgrey })
-- normal text
...
Group.new('SpellLocal', '#F0E2B5', c.none, no)
...
Group.new('SpellRare', '#F0E2B5', c.none, no)
