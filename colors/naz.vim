...
call s:h('rsKeyword',          { 'fg': '#CCFF00', 'format': 'bold' })
...
call s:h('TSVariable', { 'fg': '#ffc833' })
call s:h('TSBoolean',  { 'fg': '#d666ff' })

"call s:h(TSAnnotation BlueItalic)
"call s:h(TSAttribute BlueItalic)
"call s:h(link TSCharacter Yellow)
"call s:h(TSComment Grey)
"call s:h(TSConditional Red)
"call s:h(TSConstBuiltin OrangeItalic)
"call s:h(TSConstMacro Orange)
"call s:h(TSConstant OrangeItalic)
"call s:h(TSConstructor Fg)
"call s:h(TSError ErrorText)
"call s:h(TSException Red)
"call s:h(TSField Green)
"call s:h(TSFloat Purple)
"call s:h(TSFuncBuiltin Green)
"call s:h(TSFuncMacro Green)
"call s:h(TSFunction Green)
"call s:h(TSInclude BlueItalic)
"call s:h(TSKeyword Red)
"call s:h(TSKeywordFunction Red)
"call s:h(TSLabel Red)
"call s:h(TSMethod Green)
"call s:h(TSNamespace Purple)
"call s:h(TSNumber Purple)
"call s:h(TSOperator Red)
"call s:h(TSParameter OrangeItalic)
"call s:h(TSParameterReference OrangeItalic)
"call s:h(TSProperty Green)
"call s:h(TSPunctBracket Fg)
"call s:h(TSPunctDelimiter Grey)
"call s:h(TSPunctSpecial Fg)
"call s:h(TSRepeat Red)
"call s:h(TSString Yellow)
"call s:h(TSStringEscape Green)
"call s:h(TSStringRegex Green)
"call s:h(TSStructure BlueItalic)
"call s:h(TSTag BlueItalic)
"call s:h(TSTagDelimiter Red)
"call s:h(TSText Green)
"call s:h('TSEmphasis', s:palette.none, s:palette.none, 'format': 'bold')
"call s:h('TSUnderline', s:palette.none, s:palette.none, 'format': 'underline')
"call s:h('TSType BlueItalic)
"call s:h(TSTypeBuiltin BlueItalic)
"call s:h(TSURI markdownUrl)
" call s:h(TSVariableBuiltin OrangeItalic)
